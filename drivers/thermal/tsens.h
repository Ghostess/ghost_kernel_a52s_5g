...
#else
#define TSENS_DBG1(dev, msg, x...) do { } while (0)
#define TSENS_DBG(dev, msg, x...) do { } while (0)
#define TSENS_INFO(dev, msg, x...) do { } while (0)
#define TSENS_ERR(dev, msg, x...) do { } while (0)
#define TSENS_DUMP(dev, msg, x...) do { } while (0)
#endif
